...
<head>
    ...
    <style>
        ...
        /* ==========================================
           6. KHU VỰC CÁC TÍNH NĂNG (FEATURES)
           ========================================== */
        .icon-outer { 
            box-sizing: border-box; 
            float: left; 
        ...
        /* Responsive cơ bản cho thiết bị di động */
        @media (max-width: 768px) {
            .one-third, .two-third, .icon-outer { width: 100%; float: none; padding-left: 0; text-align: center; }
            #navbar { float: none; display: block; margin-top: 15px; text-align: center; }
        }
    </style>
</head>
<body>
    ...
    <div class="normal-wrapper">
        <div class="icon-outer">
            <div class="icon-circle"><i class="fa fa-youtube"></i></div>
            <h5>YouTube</h5>
            <p>Checkout our YouTube channel for more tech reviews!</p>
        </div>
        <div class="icon-outer">
            <div class="icon-circle"><i class="fa fa-camera-retro"></i></div>
            <h5>Reviews</h5>
            <p>In-depth reviews of the latest devices.</p>
        </div>
        <div class="icon-outer">
            <div class="icon-circle"><i class="fa fa-dollar"></i></div>
            <h5>Buying Guides</h5>
            <p>Best stuff for the lowest amount of money.</p>
        </div>
    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var time = 2500; // Đổi ảnh sau 2.5 giây
            ...
            function changeImage(){
                if(currentImage == 1) { 
                    $im1.hide(); $im2.show(); $im3.hide(); currentImage = 2; 
                } else if(currentImage == 2) { 
                    $im1.hide(); $im2.hide(); $im3.show(); currentImage = 3; 
                } else { 
